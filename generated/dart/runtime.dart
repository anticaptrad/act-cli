...
Map<String, String> loadEnvMap(
  ...
  final out = <String, String>{};
  final actAccessToken = pick(['ACT_ACCESS_TOKEN'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, null);
  if (actAccessToken != null) out['ACT_ACCESS_TOKEN'] = actAccessToken;
  final actApiUrl = pick(['ACT_API_URL'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, null);
  if (actApiUrl != null) out['ACT_API_URL'] = actApiUrl;
  final actCliBind = pick(['ACT_CLI_BIND'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, '127.0.0.1:9090');
  if (actCliBind != null) out['ACT_CLI_BIND'] = actCliBind;
  return out;
}
